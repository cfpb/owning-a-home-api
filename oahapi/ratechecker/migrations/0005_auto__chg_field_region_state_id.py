...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.state_id'
        db.alter_column(u'ratechecker_region', 'state_id', self.gf('localflavor.us.models.USStateField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Region.state_id'
        db.alter_column(u'ratechecker_region', 'state_id', self.gf('django.db.models.fields.CharField')(max_length=2))
