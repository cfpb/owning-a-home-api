...
class RateCheckerParameters(object):
    ...
    def set_loan_amount(amount):
        self.loan_amount = int(amount)

    def set_price(price):
        self.price = int(price)

    def set_state(state_two_letter):
