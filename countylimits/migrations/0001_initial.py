    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county_fips', models.CharField(help_text="A three-digit FIPS code for the state's county", max_length=3)),
                ('county_name', models.CharField(help_text='The county name', max_length=100)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('state_fips', models.CharField(help_text='A two-digit FIPS code for the state', max_length=2)),
                ('state_abbr', localflavor.us.models.USStateField(help_text='A two-letter state abbreviation', max_length=2)),
            ],
            options={
                'ordering': ['state_fips'],
            },
