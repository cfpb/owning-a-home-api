...
class RateQueryTestCase(TestCase):
    ...
    def setUp(self):
        ...
        PRODUCTS = [
            ...
            [98, 'Institution 8', 'PURCH', 'FIXED', 'CONF', 30, None, None, 0, None, None, None, None, None, None, 1, 95, 680, 740, 90000, 550000, 1, 1, 0],  # noqa
            [99, 'Institution 8', 'PURCH', 'FIXED', 'CONF', 30, None, None, 0, None, None, None, None, None, None, 1, 90, 680, 740, 90000, 550000, 1, 1, 0],  # noqa
        ]
        RATES = [
        ...
        ADJUSTMENTS = [
            ...
            [8, 98, 'P', '0.125', 100000, 500000, 'CONDO', 660, 780, 30, 95, 'MD'],  # noqa
            [9, 99, 'P', '0.125', 100000, 500000, 'CONDO', 660, 780, 30, 95, 'MD'],  # noqa
        ]
