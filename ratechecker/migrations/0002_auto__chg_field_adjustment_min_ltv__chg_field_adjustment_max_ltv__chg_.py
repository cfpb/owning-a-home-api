...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ratechecker_adjustment', 'min_ltv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))

        # Changing field 'Adjustment.max_ltv'
        db.alter_column(u'ratechecker_adjustment', 'max_ltv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))

        # Changing field 'Product.max_ltv'
        db.alter_column(u'ratechecker_product', 'max_ltv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))

        # Changing field 'Product.min_ltv'
        db.alter_column(u'ratechecker_product', 'min_ltv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.max_ltv'
        db.alter_column(u'ratechecker_product', 'max_ltv', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Product.min_ltv'
        db.alter_column(u'ratechecker_product', 'min_ltv', self.gf('django.db.models.fields.FloatField')(default=None))
