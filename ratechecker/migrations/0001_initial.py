    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affect_rate_type', models.CharField(max_length=1, choices=[('P', 'Points'), ('R', 'Rate')])),
                ...
                ('prop_type', models.CharField(max_length=18, null=True, choices=[('CONDO', 'Condo'), ('COOP', 'Co-op'), ('CASHOUT-REFI', 'Cash-out refinance')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_purpose', models.CharField(max_length=12, choices=[('REFI', 'Refinance'), ('PURCH', 'Purchase')])),
                ('pmt_type', models.CharField(default='FIXED', max_length=12, choices=[('FIXED', 'Fixed Rate Mortgage'), ('ARM', 'Adjustable Rate Mortgage')])),
                ('loan_type', models.CharField(max_length=12, choices=[('JUMBO', 'Jumbo Mortgage'), ('CONF', 'Conforming Loan'), ('AGENCY', 'Agency Loan'), ('FHA', 'Federal Housing Administration Loan'), ('VA', 'Veterans Affairs Loan'), ('VA-HB', 'VA-HB Loan'), ('FHA-HB', 'FHA-HB Loan')])),
                ('loan_term', models.IntegerField()),
                ('int_adj_term', models.IntegerField(help_text='1st part of the ARM definition. E.g. 5 in 5/1 ARM', null=True)),
                ...
                ('int_adj_cap', models.IntegerField(help_text='Max percentage points the rate can adjust at first adjustment.', null=True)),
                ('annual_cap', models.IntegerField(help_text='Max percentage points adjustable at each subsequent adjustment', null=True)),
                ('loan_cap', models.IntegerField(help_text='Total lifetime maximum change that the ARM rate can have.', null=True)),
