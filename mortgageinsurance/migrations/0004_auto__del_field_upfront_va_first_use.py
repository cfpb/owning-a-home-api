...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Upfront.va_first_use'
        db.delete_column(u'mortgageinsurance_upfront', 'va_first_use')


    def backwards(self, orm):
        # Adding field 'Upfront.va_first_use'
        db.add_column(u'mortgageinsurance_upfront', 'va_first_use',
