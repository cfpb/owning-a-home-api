...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mortgageinsurance_monthlymortgageins', (
            ...
            ('min_ltv', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('max_ltv', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('min_fico', self.gf('django.db.models.fields.IntegerField')()),
            ('max_fico', self.gf('django.db.models.fields.IntegerField')()),
            ('min_loan_term', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('max_loan_term', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
    ...
    models = {
        u'mortgageinsurance.monthlymortgageins': {
            ...
            'max_loan_term': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'max_ltv': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            ...
            'min_loan_term': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'min_ltv': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
